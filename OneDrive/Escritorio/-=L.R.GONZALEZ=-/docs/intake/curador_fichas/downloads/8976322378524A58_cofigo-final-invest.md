# Ficha Curador SETO - cofigo final invest.txt

| campo | valor |
|---|---|
| Ruta original | `C:\Users\L-Tyr\Downloads\New folder\cofigo final invest.txt` |
| SHA256 | `8976322378524A5828B424A4C0B0166B06F0557006D3C4E0F75C53C1E6E0D7B6` |
| Bytes | `260734` |
| Tipo | `file` |
| Estado PSI | `CERTEZA` |
| Status | `REGISTRADO` |
...
| ActionGate | `REVIEW` |
| Canonico | `C:\Users\L-Tyr\Downloads\New folder\cofigo final invest.txt` |
...
- Evidencia: SHA256 `8976322378524A5828B424A4C0B0166B06F0557006D3C4E0F75C53C1E6E0D7B6`.
