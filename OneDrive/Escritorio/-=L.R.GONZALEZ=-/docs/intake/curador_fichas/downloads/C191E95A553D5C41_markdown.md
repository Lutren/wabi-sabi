# Ficha Curador SETO - ```markdown.txt

| campo | valor |
|---|---|
| Ruta original | `C:\Users\L-Tyr\Downloads\New folder\```markdown.txt` |
| SHA256 | `C191E95A553D5C41ECB825E53E880A4E7C9612CB6EB9B78EFF3D5B74AF68F370` |
| Bytes | `61905` |
| Tipo | `file` |
| Estado PSI | `CERTEZA` |
| Status | `REGISTRADO` |
...
| ActionGate | `REVIEW` |
| Canonico | `C:\Users\L-Tyr\Downloads\New folder\```markdown.txt` |
...
- Evidencia: SHA256 `C191E95A553D5C41ECB825E53E880A4E7C9612CB6EB9B78EFF3D5B74AF68F370`.
